...
async function initGame() {
    ...
    document.getElementById('userGreeting').innerText = `¡Hola ${name}! Vamos a jugar con sumas más grandes.`;
...
function generateQuestion() {
    const a = randomNumber(10, 25);
    const b = randomNumber(10, 25);
    const text = `${a} + ${b}`;
...
async function handleAnswer() {
    ...
    if (correct) {
        ...
        feedback.innerText = '¡Perfecto! Ganaste 30 puntos ✨';
